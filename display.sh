...
echo ""
echo "IMPORTANT! You need to enable I2C communication."
...
echo "-------------------------------------------------------------"
echo ""
echo "Script has finished, you should see an IP address on your display"
echo "if you have enabled I2C and wired it correctly"
echo ""
echo "Next Steps:"
